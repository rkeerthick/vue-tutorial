...
const handleSubmit = async () => {
    const updatedJob = {
        ...
        company: {
            ...
            contactNumber: form.company.contactNumber,
        },
    }
...
onMounted(async() => {
    try {
       ...
       form.title = state.job.title;
        ...
        form.company.contactNumber = state.job.company.contactNumber;
            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactNumber" type="tel" id="contact_phone" name="contact_phone"
